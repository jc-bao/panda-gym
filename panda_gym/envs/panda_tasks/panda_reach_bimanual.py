...
class PandaReachBimanualEnv(BimanualTaskEnv):
    ...
    def __init__(self, render: bool = False, control_type: str = "ee", has_object = False, obj_not_in_hand_rate = 0) -> None:
        ...
        task = ReachBimanual(sim, robot0.get_ee_position, robot1.get_ee_position, has_object = has_object, obj_not_in_hand_rate = obj_not_in_hand_rate)
